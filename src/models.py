...
#                 self.tokenizer(
#                     "<extra_id_0> "
#                     + self.tokenizer.decode(self.label_words_list[0][0])
#                     + " <extra_id_1>"
#                 ).input_ids
#                 for _ in labels
#             ]
...
#             logits.append(
#                 prediction_mask_scores[
#                     :, 1, self.label_words_list[label_id][0]
#                 ].unsqueeze(-1)
#             )  # 1 means second output e.g the prediction of "great"
#         """
#         The following is same as Roberta
#         """
#         logits = torch.cat(logits, -1)
...
#         if self.config.num_labels == 1:
#             logsoftmax = nn.LogSoftmax(-1)
#             logits = logsoftmax(logits)  # Log prob of right polarity (important!)
