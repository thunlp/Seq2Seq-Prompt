...
def main():
    ...
    parser.add_argument(
        "--test_key2", type=str, default="", help="Second test metric name"
    )
    ...
    if len(args.key) == 0:
        ...
        elif condition["task_name"] == "cb/acc":
            args.key = "cb_dev_eval_acc"
            args.test_key = "cb_test_eval_acc"
            args.test_key2 = "cb_test_eval_f1"
            condition["task_name"] = "cb"
        elif condition["task_name"] == "cb/f1":
            args.key = "cb_dev_eval_f1"
            args.test_key2 = "cb_test_eval_acc"
            args.test_key = "cb_test_eval_f1"
            condition["task_name"] = "cb"
        elif condition["task_name"] == "copa":
            args.key = "copa_dev_eval_acc"
            args.test_key = "copa_test_eval_acc"
        elif condition["task_name"] == "multirc/em":
            args.key = "multirc_dev_eval_em"
            args.test_key = "multirc_test_eval_em"
            args.test_key2 = "multirc_test_eval_f1"
            condition["task_name"] = "multirc"
        elif condition["task_name"] == "multirc/f1":
            args.key = "multirc_dev_eval_f1"
            args.test_key2 = "multirc_test_eval_em"
            args.test_key = "multirc_test_eval_f1"
            condition["task_name"] = "multirc"
        elif condition["task_name"] == "record/em":
            args.key = "record_dev_eval_em"
            args.test_key = "record_test_eval_em"
            args.test_key2 = "record_test_eval_f1"
            condition["task_name"] = "record"
        elif condition["task_name"] == "record/f1":
            args.key = "record_dev_eval_f1"
            args.test_key2 = "record_test_eval_em"
            args.test_key = "record_test_eval_f1"
            condition["task_name"] = "record"
        elif condition["task_name"] == "wic":
            args.key = "wic_dev_eval_acc"
            args.test_key = "wic_test_eval_acc"
        elif condition["task_name"] == "wsc":
            args.key = "wsc_dev_eval_acc"
            args.test_key = "wsc_test_eval_acc"
        else:
    ...
    for i, seed in enumerate(seed_best):
        ...
        print(
            "%s: best dev (%.5f) test (%.5f) %s | total trials: %d"
            % (
                seed,
                seed_best[seed][args.key],
                seed_best[seed][args.test_key],
                "test2 (%.5f)" % (seed_best[seed][args.test_key2])
                if len(args.test_key2) > 0
                else "",
