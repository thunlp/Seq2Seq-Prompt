...
def main():
    ...
    for seed in seed_result:
        ...
        # Load all mappings
        with open(
            os.path.join(args.mapping_dir, print_name, "{}-{}.txt".format(args.k, seed))
        ) as f:
            mappings = []
            for line in f:
        ...
        fsort = open(
            os.path.join(
                args.mapping_dir, print_name, "{}-{}.sort.txt".format(args.k, seed)
            ),
            "w",
        )
        fscore = open(
            os.path.join(
                args.mapping_dir, print_name, "{}-{}.score.txt".format(args.k, seed)
            ),
            "w",
        )
